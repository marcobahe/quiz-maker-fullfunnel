# Formulário de Depoimento — QuizMeBaby
...
*(Ex: CPL alto, leads frios, processo manual demais...)*
...
**3. Em uma frase, como você descreveria o QuizMeBaby para um colega?**

*(Essa vai ser a sua "quote" principal — pode ser espontânea mesmo!)*

---

**4. Qual funcionalidade você mais usa e por quê?**
...
*Qualquer dúvida, é só responder aqui. Obrigado(a) demais!*

*[Assinatura da equipe]*

---

> **Nota interna:** Após receber as respostas, preencher `template-coleta.md` e mover arquivos para `docs/cases/raw/[slug-cliente]/`.
