...
function QuizPlayer({ quizData }) {
  ...
  // ── Initialize quiz from server-provided data ────────────────
  // Data comes from the server component (page.jsx) via the quizData prop
  // This eliminates the client-side fetch waterfall that caused 19.2s LCP
...
// quizData comes from the server component (page.jsx) — eliminates client-side fetch waterfall
export default function QuizPlayerClient({ quizData }) {
  return (
    <Suspense
      fallback={
        <div
